...
class ProductService {
    ...
    async addProduct(name, description, brand, category, price, cost, isAvailable, specs, instock, images, modelNumber, warrantyPeriod) {
    ...
    async updateProduct(productId, name, description, brand, category, price, cost, isAvailable, specs, instock, images, modelNumber, warrantyPeriod) {
        const formData = new FormData();
        // Append other fields
        formData.append('name', name);
        formData.append('description', description);
