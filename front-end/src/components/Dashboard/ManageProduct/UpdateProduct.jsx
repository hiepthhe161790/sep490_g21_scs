...
import {
    ...
    CloudUpload as CloudUploadIcon, BuildCircle as BuildCircleIcon, Info as InfoIcon
...
const UpdateProduct = forwardRef(({ targetProduct, onUpdateSuccess }, ref) => {
    // các state nhỏ
    ...
    const [modelNumber, setModelNumber] = React.useState(targetProduct?.modelNumber || "");
    const [warrantyPeriod, setWarrantyPeriod] = React.useState(targetProduct?.warrantyPeriod || 0);
    ...
    const handleUpdateProduct = async (e) => {
        ...
        try {
            const response = await ProductService.updateProduct(
                targetProduct._id, name, description, brand, category,
                price, cost, isAvailable, specs, instock, images,
            ...
            <React.Fragment>
                ...
                >
                    ...
                    <DialogContent>
                        ...
                        <DialogContentText>
                            Vui lòng cập nhật thông tin sản phẩm dưới đây.
                        </DialogContentText>
                        <Grid sx={{ mt: 3 }} container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <TextField
                                    fullWidth id="standard-basic"
                                    type="number" label="Thời gian bảo hành (tháng)"
                                    variant="standard" value={warrantyPeriod}
                            ...
                            <Grid item xs={3}>
                                ...
                                >
                                    <DialogTitle>Tạo thêm hãng</DialogTitle>
                                    <DialogContent>
                                        <DialogContentText>
                                            Vui lòng nhập đầy đủ thông tin sau để thêm hãng mới.
                                        </DialogContentText>
                                        <TextField
                                            autoFocus
                            ...
                            <Grid item xs={3}>
                                ...
                                >
                                    ...
                                    <DialogContent>
                                        <DialogContentText>
                                            Vui lòng nhập đầy đủ thông tin sau để thêm danh mục mới.
                                        </DialogContentText>
                                        <TextField
                                            autoFocus
                    ...
                    <DialogActions>
                        ...
                        <Button type="submit" onClick={handleUpdateProduct}>Cập nhật</Button>
                    </DialogActions>
                </Dialog>
            </React.Fragment>
        </>
